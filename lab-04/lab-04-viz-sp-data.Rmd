...
None of these stats are surpising, Texas and California make sense to be the most popular states while Delaware and Vermont I would also assume to have some of the least.
...
- State with highest density: The District of Columbia
...
dn_lq %>%
  ...
  labs(
    title = "Dennys and La quinta locations in NC",
    x = "longitude",
    y = "latitude"
  )
```
...
A considerable amount of the locations are quite close to each other. Alpha 0.7 works the best visually.
...
dn_lq %>%
  ...
  geom_point(alpha = 0.7) +
  labs(
    title = "Dennys and La quinta locations in TX",
    x = "longitude",
    y = "latitude"
  )
```
...
The joke also holds in Texas. Many of the locations are close to each other.

**Compare North Carolina and Texas: In which state does the joke seem more accurate?**

I would argue Texas because there's a higher quantity of relations to this topic.
