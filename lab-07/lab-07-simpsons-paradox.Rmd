...
ggplot(data = Whickham, aes(x = smoker, fill = outcome)) +
  ...
  facet_wrap(~age_cat) +
  labs(
    title = "Smoking Status vs Outcome by Age Group",
    x = "Smoker",
    y = "Proportion",
    fill = "Outcome"
  )
...
**Overall (from Exercise 5):** Smokers appeared to have increased survival rates compared to non-smokers.

**Within each age group (from Exercise 7):** Smokers appear to have a higher death rate among all age groups compared to non-smokers.

**What might explain this change?**

Consider:

- Which age groups have more smokers? the 18-44 age group has the most smokers.
- Which age groups have higher survival rates overall? The younger age groups have the higher survival rates, decreasing as you get older.
- How might age affect both smoking status and survival? Your immune system alongside the longevity of smoking will create organ failure.
...
**Reflection question:** Can you think of other situations where Simpson's paradox might occur? What confounding variables should researchers watch out for in studies about health, education, or economics? A drinking/alcoholics study would most likely have a similar data spread. Age and health correlate greatly, so age groups tell a big part of the story in these health related studies.
